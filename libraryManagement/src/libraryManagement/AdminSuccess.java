...
public class AdminSuccess extends JFrame {
    ...
    public AdminSuccess() {
        ...
        lbAdminSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
        lbAdminSection.setForeground(Color.GRAY);
       ...
       JButton btnNewButton = new JButton("Add Librarian");
        ...
        gl_contentPane.setHorizontalGroup(
        		...
        		.addGroup(gl_contentPane.createSequentialGroup()
        				...
        				.addComponent(lbAdminSection, GroupLayout.PREFERRED_SIZE, 151, GroupLayout.PREFERRED_SIZE)
        				.addGap(123))
         ...
         gl_contentPane.setVerticalGroup(
        		 ...
        		 .addGroup(gl_contentPane.createSequentialGroup()
        				 .addComponent(lbAdminSection, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
        				 .addGap(11)
